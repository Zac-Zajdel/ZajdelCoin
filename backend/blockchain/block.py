...
class Block:
  ...
  def is_valid_block(last_block, block):
    ...
    if block.last_hash != last_block.hash:
      raise Exception('The block last_hash does not equal the last_blocks hash value.')
    ...
    if block.hash != reconstructed_hash:
      raise Exception('The block hash must be correct. Data was corrupted/tampered')
